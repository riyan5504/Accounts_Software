        ...
        <div class="container-fluid">
            <div class="row bg-info opacity-75 rounded p-1">
                ...
                <div class="col-sm-4 text-end no-print mt-1">
                    <a href="{{ route('sales.pdf', $sales->id) }}" class="btn btn-outline-danger btn-sm"
                        title="Download PDF">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="row">
                            ...
                            <div class="col-md-8 ms-1 mt-2">
                                ...
                                <table class="table table-sm table-borderless">
                                    <tr>
                                        ...
                                        <td>{{ $sales->customer->c_name ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <th>Address:</th>
                                        <td>{{ $sales->customer->address ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <th>Phone:</th>
                                        <td>{{ $sales->customer->phone ?? 'N/A' }}</td>
                                    </tr>
                                    <tr>
                                        <th>Email:</th>
                                        <td>{{ $sales->customer->email ?? 'N/A' }}</td>
                                    </tr>
                                </table>
                            </div>
                            <!-- INVOICE INFORMATION -->
                            <div class="col-md-3 mt-2">
                                ...
                                <table class="table table-sm table-borderless">
                                    ...
                                    <tr>
                                        <th>Date:</th>
                                        <td>{{ $sales->date->format('d-m-Y') }}</td>
                                    </tr>
                                    <tr>
                                        <th>sales By:</th>
                                        <td>{{ optional($sales->user)->name ?? (auth()->user()->name ?? 'Admin') }}</td>
                                    </tr>
                                    @if ($sales->reference)
                                        <tr>
                                            <th>Reference:</th>
                        ...
                        <div class="card-body p-1">
                            ...
                            <table class="table table-bordered table-sm align-middle">
                                ...
                                <tbody>
                                    @forelse ($sales->salesItems as $singleItm)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                {{ number_format((float) $singleItm->sales_price, 2) }}
                                            </td>
                                            <td class="text-end">
                                                {{ number_format((float) $singleItm->price, 2) }}
                                            </td>
                                            <td class="text-end">
                                                {{ number_format((float) $singleItm->item_vat_amt, 2) }}
                                            </td>
                                        ...
                                        <table class="table table-bordered table-sm history-table">
                                            ...
                                            <tfoot>
                                                <tr class="table-light">
                                                    <th colspan="4">Customer Payment Total</th>
                                                    <th class="text-end">
                                ...
                                <div class="col-md-6 mt-3">
                                    <table class="table table-sm summary-table">
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                {{ number_format($sales->salesItems->sum('qty'), 2) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Sub Total:</td>
                                            <td class="text-end">
                                                {{ number_format((float) $sales->sub_total, 2) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>VAT Amount:</td>
                                            <td class="text-end">
                                                {{ number_format((float) $sales->vat_amt, 2) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                @if (!empty($sales->dis_percent))
                                                    Discount Amount
                                                    ({{ $sales->dis_percent }}%):
                                                @else
                                                    Discount Amount:
                                            ...
                                            <td class="text-end">
                                                {{ number_format((float) $sales->dis_amt, 2) }}
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="border-top">
                                            ...
                                            <th class="text-end">{{ number_format($originalSales, 2) }}</th>
                                        </tr>

                                        <!-- RETURN -->
                                        @if ($hasReturns)
                                            <tr>
                                                <td class="text-danger">sales Return:</td>
                                        ...
                                        @if ($hascustomerPayment)
                                            <tr>
                                                <td>Later customer Payment:</td>
                                                <td class="text-end">{{ number_format($customerPayment, 2) }}</td>
                                            </tr>
                                        @endif
                                        <!-- TOTAL PAID -->
