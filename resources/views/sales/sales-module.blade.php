            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box text-bg-primary">
                        <div class="inner">
                            <a href="{{ url('/sales/entry') }}" class=" link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                <p>Sales Entry</p>
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box text-bg-success">
                        <div class="inner">
                            <a href="{{ url('/sales/list') }}" class="link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                <p>Sales List</p>
                            </a>
                        </div>
                        <svg class="small-box-icon" fill="currentColor" viewBox="0 0 24 24"
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box text-bg-primary">
                        <div class="inner">
                            <a href="{{ url('/sales/return/entry') }}" class=" link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                <p style="font-size: 22px">Sales Return Entry</p>
                            </a>
                        </div>
                        <svg class="small-box-icon" fill="currentColor" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box text-bg-info">
                        <div class="inner">
                            <a href="{{ route('sales.customer.add') }}" class=" link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                <p>Customer Entry</p>
                            </a>
                        </div>
                        ...
                        <a href="{{ route('sales.customer.add') }}"
                            class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                           Entry Here <i class="bi bi-link-45deg"></i>
                        </a>
                    </div>
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box text-bg-info">
                        <div class="inner">
                            <a href="{{ route('sales.customer.list') }}" class=" link-light link-underline-opacity-0 link-underline-opacity-50-hover">
                                <p>Customer List</p>
                            </a>
                        </div>
                        <svg class="small-box-icon" fill="currentColor" viewBox="0 0 24 24"
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box text-bg-info">
                        <div class="inner">
                            <a href="{{route('sales.customer.received.create')}}" class=" link-light link-underline-opacity-0 link-underline-opacity-50-hover">
