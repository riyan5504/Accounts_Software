...
<head>
    <meta charset="utf-8">
    <title>Sales - {{ $sales->invoice_no }}</title>
    <style>
        body {
            ...
            <td class="customer-info">
                <table class="info-inner-table">
                    ...
                    <tr>
                        ...
                        <td style="line-height: 14px;">{{ $sales->customer->address ?? 'N/A' }}</td>
                    </tr>
                    <tr>
            ...
            <td class="invoice-info">
                <table class="info-inner-table">
                    ...
                    <tr>
                        <td class="text-right">
                            <strong>Date:</strong>
                            {{ $sales->date ? $sales->date->format('d M Y') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                        <td class="text-right">
                            <strong>Sales By:</strong>
                            {{ optional($sales->user)->name ?? 'Admin' }}
                        </td>
                    </tr>
                    @if ($sales->reference)
                        <tr>
    ...
    <table class="items-table">
        <thead>
            <tr>
                ...
                <th style="width:12%;">Sales Qty</th>
        ...
        <tbody>
            @forelse ($sales->salesItems as $singleItm)
                <tr>
                    ...
                    <td class="text-right">{{ number_format((float) $singleItm->sales_price, 2) }}</td>
                ...
                <table class="summary-table">
                    ...
                    <tr class="summary-border-top grand-total-row">
                        ...
                        <th class="summary-value">
                            {{ number_format($originalSales, 2) }}
                        </th>
                    </tr>
                    @if ($hasReturns)
                        <tr class="return-row">
                            <td class="summary-label">Sales Return:</td>
                            <td class="summary-value">
                                @if ($totalReturn > 0)
