        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline mb-2">
                ...
                <div class="card-header">
                    <div class="card-title">Account Edit</div>
                </div>
                <!--end::Header-->
                <!--begin::Form-->
                    ...
                    <div class="card-body">
                        <div id="accountsContainer" class="border-0 shadow-sm">
                            <div
                                ...
                                <h4 class="mb-0 ms-1">Edit Account Details</h4>
                            </div>
                            <div class="account-row row g-2 align-accounts-end mb-2">
                                ...
                                <div class="form-group col-sm-6 col-md-3 mb-1">
                                    <input type="text" name="account_name" class="form-control account_name"
                                        placeholder=" " value="{{ $account->account_name }}" required />
                                    <label for="account_name" class="floating-label">Account Name</label>
                                </div>
                                <div class="form-group col-sm-6 col-md-3 mb-1">
                                    <input type="text" value="{{ $account->ac_cat }}" name="ac_cat"
                                        class="form-control ac_cat" placeholder=" " required />
                                ...
                                <div class="form-group col-sm-6 col-md-3 mb-1">
                                    <select name="ac_type" class="form-control ac_type" placeholder=" ">
                                        @foreach (['Asset', 'Liability', 'Equity', 'Revenue', 'Expense'] as $type)
                                            <option value="{{ $type }}"
                                                {{ $account->ac_type == $type ? 'selected' : '' }}>
                                                {{ $type }}
                                            </option>
                                        @endforeach
                                    </select>
                                    {{-- <select name="ac_type" class="form-control ac_type" placeholder=" ">
                                        <option value="Asset" @if ($account->ac_type == 'Asset') selected @endif>Asset
                                        </option>
                                        <option value="Liability" @if ($account->ac_type == 'Liability') selected @endif>
                                            Liability</option>
                                        <option value="Equity" @if ($account->ac_type == 'Equity') selected @endif>Equity
                                        </option>
                                        <option value="Revenue" @if ($account->ac_type == 'Revenue') selected @endif>Revenue
                                        </option>
                                        <option value="Expense" @if ($account->ac_type == 'Expense') selected @endif>Expense
                                        </option>
                                    </select> --}}
                                ...
                                <div class="form-group col-sm-6 col-md-3 mb-1">
                                    <input type="number" step="0.01" name="op_balance" class="form-control op_balance"
                                        value="{{ $account->op_balance }}" placeholder=" " required />
