    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row bg-info opasity-50 rounded">
                <div class="col-sm-4">
                    <h4 class="mb-0 mt-0">Edit Purchase</h4>
                </div>
                <div class="col-sm-8">
                    ...
                    <div class="card-body">
                        ...
                        <div id="vendorContainer" class="border-0 shadow-sm ms-0">
                            ...
                            <div class="row g-2 align-vendor-end mb-1">
                                <div class="form-group col-md-5 mb-1 position-relative">
                                    <input type="text" name="v_name" value="{{ $purchase->vendor->v_name }}"
                                        class="form-control v_name" placeholder=" " required />
                                    <label for="v_name" class="floating-label">Vendor Name</label>
                                    <input type="hidden" name="vendor_id" value="{{ $purchase->vendor->id }}"
                                        class="form-control vendor_id" placeholder=" " />
                                ...
                                <div class="form-group col-md-3 mb-1">
                                    <input type="text" name="phone" value="{{ $purchase->vendor->phone }}"
                                        class="form-control phone" placeholder=" " required />
                                    <label for="phone" class="floating-label">Phone</label>
                                </div>
                                <div class="form-group col-md-4 mb-1">
                                    <input type="email" name="email" value="{{ $purchase->vendor->email }}"
                                ...
                                <div class="form-group col-md-2 mb-1">
                                    <input type="date" name="date" value="{{ optional($purchase->date)->format('Y-m-d') }}" class="form-control date"
                                ...
                                <div class="form-group col-md-2 mb-1">
                                    <input type="text" name="invoice_no" class="form-control invoice_no" id="invoice_no"
                                        value="{{ $purchase->invoice_no }}" placeholder=" " readonly />
                        ...
                        <div id="itemContainer" class="border-0 shadow-sm">
                            ...
                            @foreach ($purchase->purchaseItems as $purchaseItem)
                                @php
                                    $singelItem = $purchaseItem->item;
                                @endphp
                                <div class="item-row row g-2 align-items-end mb-2">
                                    <div class="form-group col-md-2 mb-1">
                                        <input type="text" name="item_name[]" value="{{ $singelItem->item_name }}"
                                    ...
                                    <div class="form-group col-md-1 mb-1">
                                        <input type="text" name="item_code[]" value="{{ $singelItem->item_code }}"
                                            class="form-control item_code" placeholder=" " readonly />
                                        <label for="item_code" class="floating-label">Item Code</label>
                                    </div>
                                    <div class="form-group col-md-1 mb-1">
                                        <input type="text" name="cat_name[]"
                                            value="{{ $singelItem->category->cat_name }}" class="form-control cat_name"
                                            placeholder=" " required />
                                        <label for="cat_name" class="floating-label">Category</label>
                                    </div>
                                    <div class="form-group col-md-1 mb-1">
                                        <input type="text" name="size[]" value="{{ $singelItem->size }}"
                                    ...
                                    <div class="form-group col-md-2 d-flex align-items-end mb-1">
                                        <div class="w-100">
                                            <input type="number" step="0.01" name="total_price[]"
                                                value="{{ $purchaseItem->total_price }}" class="form-control total_price"
                                                placeholder=" " readonly>
                        ...
                        <div class="row g-2">
                            <div class="form-group col-md-1 mt-2 mb-2">
                                <input type="number" name="dis_percent" value="{{ $purchase->dis_percent }}"
                                    class="form-control dis_percent" placeholder=" ">
                            ...
                            <div class="form-group col-md-2 mb-2">
                                <input type="text" name="pay_to" class="form-control pay_to"
                                    value="{{ $purchase->pay_to }}" placeholder=" " />
                            ...
                            <div class="form-group col-md-2 mb-2">
                                <select name="payment_method" class="form-control payment_method" placeholder=" "
                                    ...
                                    <option value="mobile_bank"
                                        {{ $purchase->payment_method == 'mobile_bank' ? 'selected' : '' }}>Mobile
                                        Banking</option>
                                    <option value="due" {{ $purchase->payment_method == 'due' ? 'selected' : '' }}>Due
                                    </option>
                                </select>
                            ...
                            <div class="form-group col-md-2 mb-2">
                                <select name="payment_status" class="form-control payment_status" placeholder=" "
                                    ...
                                    <option value="partial"
                                        {{ $purchase->payment_status == 'partial' ? 'selected' : '' }}>Partial</option>
                                </select>
                                ...
                                <select name="debit_account_id" class="form-control debit_account_id" required>
                                    ...
                                    @foreach ($accounts as $account)
                                        <option value="{{ $account->id }}"
                                            ...
                                            {{ $purchase->debit_account_id == $account->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group col-md-2 mb-2">
                                <select name="credit_account_id" class="form-control credit_account_id" required>
                                    ...
                                    @foreach ($accounts as $account)
                                        <option value="{{ $account->id }}"
                                            {{ $purchase->credit_account_id == $account->id ? 'selected' : '' }}>
                                            {{ $account->account_name }}
                                        </option>
                                    @endforeach
                                </select>
