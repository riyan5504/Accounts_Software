                        ...
                        <div id="itemsContainer" class="border-0 shadow-sm">
                            ...
                            <div class="item-row row g-2 align-items-end">
                                <div class="form-group col-sm-4 col-md-2 mb-1">
                                    <input type="text" name="item_name" value="{{$item->item_name}}" class="form-control item_name" placeholder=" "
                                        required />
                                    <label for="item_name" class="floating-label">Item Name</label>
                                </div>
                                <div class="form-group col-sm-4 col-md-2 mb-1">
                                    <input type="text" name="item_code" value="{{$item->item_code}}" class="form-control item_code" placeholder=" " />
                                    <label for="item_code" class="floating-label">Item Code</label>
                                </div>
                                <div class="form-group col-sm-4 col-md-2 mb-1 position-relative">
                                    <input type="text" name="cat_name" value="{{$item->category->cat_name ?? ''}}" class="form-control cat_name" id="cat_name"
                                        placeholder=" " required />
                                    <label for="cat_id" class="floating-label">Category</label>

                                    <input type="hidden" name="cat_id" value="{{$item->cat_id ?? ''}}" class="cat_id" id="cat_id">
                                ...
                                <div class="form-group col-sm-4 col-md-1 mb-1">
                                    <input type="number" step="0.01" name="unit_price" value="{{$item->unit_price}}" class="form-control unit_price"
                                        placeholder=" " required />
                                    <label for="unit_price" class="floating-label">Unit Price</label>
                                </div>
                                <div class="form-group col-sm-4 col-md-1 mb-1">
                                    <input type="number" step="0.01" name="sales_price" value="{{$item->sales_price}}" class="form-control sales_price"
                                        placeholder=" "/>
